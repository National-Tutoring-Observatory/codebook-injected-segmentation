...
DATASET = {'711':'dialseg711', 'eedi':'eedi_train', 'eedi_move':'train_w_move_taxonomy', 'CLASS_all':'CLASS_all','TalkMoves_all':'TalkMoves_all'}
...
def main(args):
    print(f"Loading data from ./data/{DATASET[args.dataset]}{args.data_name}.pkl")
    loaded_data = pickle.load(open(f'./data/{DATASET[args.dataset]}{args.data_name}.pkl', 'rb'))
